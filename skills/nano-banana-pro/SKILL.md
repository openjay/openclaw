...
- Inspect the generated image when tools permit and verify it matches the request before delivery; report unverified visual quality if it cannot be inspected.
